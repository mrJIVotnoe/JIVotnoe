          ...
          <div className="grid grid-cols-1 gap-6 animate-in slide-in-from-left-4">
            ...
            <div className="bg-cyber-800 p-8 rounded-[3rem] border border-cyber-700 shadow-xl">
               <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="font-black text-white text-lg uppercase tracking-tight">System Proxy Settings</h3>
               </div>
          ...
          <div className="space-y-6 animate-in slide-in-from-bottom-4">
             <div className="bg-cyber-800 p-8 rounded-[3rem] border border-cyber-700 shadow-xl">
               <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="font-black text-white text-lg uppercase tracking-tight">Service Configuration</h3>
               </div>
               ...
               <div className="p-4 bg-cyber-900/50 rounded-2xl border border-cyber-700">
                  <p className="text-[10px] text-gray-500 uppercase font-black mb-3 tracking-widest">Commands</p>
