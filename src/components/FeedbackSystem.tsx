...
import { Observation, ObservationResult } from '../core/domain/types';
    ...
    <div className="bg-cyber-800 p-6 rounded-[2.5rem] border border-cyber-700 shadow-xl overflow-hidden relative group mt-8">
      ...
      <div className="relative z-10">
        ...
        <div className="bg-black/30 p-4 rounded-2xl border border-cyber-700 mb-6 space-y-4">
            ...
            {/* 1. Result */}
            <div>
                <label className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-2 block">Connection Status</label>
            ...
            <div className="flex gap-4">
                <div className="flex-1">
                    <label className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-2 block">Network</label>
                    <div className="flex gap-2">
                ...
                <div className="flex-1">
                    <label className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-2 block">Device</label>
                    <div className="flex gap-2">
        ...
        <button 
            onClick={openSupport}
            className="w-full flex items-center justify-center gap-3 bg-blue-600/10 text-blue-400 border border-blue-500/20 py-3 rounded-xl font-bold text-xs hover:bg-blue-600/20 transition-all"
        >
            <Send size={14} />
